 ...
 *
 * Controllers should provide a number of 'action' methods. These are public methods in the controller
...
/**
 * Returns a list of all events that will fire in the controller during iterator_apply(iterator, function)s lifecycle.
